...
#include "stdafx.h"
#include "spitonicsinesumsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicsinesumsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicsinesumsynthvoroguiwin32class"};				// the main window class name
